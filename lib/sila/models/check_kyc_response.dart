...
class CheckKycResponse extends Equatable  {
	...
	CheckKycResponse({this.success, this.status, this.message, this.reference, this.entityType, this.verificationStatus, this.verificationHistory, this.validKycLevels});
	...
	factory CheckKycResponse.fromJson(Map<String, dynamic> json) {
		return CheckKycResponse(
			...
			verificationHistory: json['verification_history'] != null ? json['verification_history'].map((v) => new VerificationHistory.fromJson(v)).toList() : null,
	...
	Map<String, dynamic> toJson() {
      ...
      data['verification_history'] = this.verificationHistory.map((v) => v.toJson()).toList();
    }
...
class VerificationHistory extends Equatable  {
	...
	VerificationHistory({this.verificationId, this.verificationStatus, this.kycLevel, this.requestedAt, this.updatedAt, this.tags, this.score, this.parentVerification});
