...
class Members extends Equatable  {
	...
	Members({this.userHandle, this.firstName, this.lastName, this.role, this.details, this.ownershipStake, this.verificationStatus, this.verificationRequired, this.verificationId, this.beneficialOwnerCertificationStatus, this.businessCertificationStatus});
	...
	factory Members.fromJson(Map<String, dynamic> json) {
		return Members(
			...
			beneficialOwnerCertificationStatus: json['beneficial_owner_certification_status'],
	...
	Map<String, dynamic> toJson() {
		...
		data['beneficial_owner_certification_status'] = this.beneficialOwnerCertificationStatus;
