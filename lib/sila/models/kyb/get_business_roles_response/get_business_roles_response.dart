...
class GetBusinessRolesResponse extends Equatable {
  final bool success;
  final String status;
  final List<dynamic> businessRoles;
  ...
  factory GetBusinessRolesResponse.fromJson(Map<String, dynamic> json) {
    return GetBusinessRolesResponse(
      ...
      status: json['status'],
      businessRoles: json['business_roles'] != null
          ? json['business_roles']
              .map((v) => new BusinessRoles.fromJson(v))
              .toList()
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.businessRoles != null) {
      data['business_roles'] =
          this.businessRoles.map((v) => v.toJson()).toList();
    }
    return data;
  }

  @override
  List<Object> get props => [this.success, this.status, this.businessRoles];
}
